...
| :--- | :--- |
| **Introducción, datos demográficos y background** | 1. ¿Podría indicar su nombre y apellido completo? <br> 2. ¿Qué edad tiene y con qué género se identifica? <br> 3. ¿En qué distrito reside actualmente? <br> 4. ¿Cuál es su estado civil y cómo está conformada su familia? <br> 5. ¿A qué se dedica profesionalmente y cuánto tiempo lleva en este rubro? <br> 6. ¿Podría resumirme brevemente su biografía o experiencia laboral (*background*)? |
| **Hábitos tecnológicos, personalidad e influencias (Transversal)** | 7. ¿Cómo se describiría en términos de personalidad (por ejemplo: desconfiado, práctico, analítico, extrovertido)? <br> 8. ¿Cuáles considera que son sus principales habilidades o fortalezas en su día a día? <br> 9. ¿Qué dispositivos tecnológicos (smartphone, tablet, computadora) prefiere utilizar para trabajar y por qué? <br> 10. ¿Qué aplicaciones móviles o canales digitales de interacción utiliza con mayor frecuencia? <br> 11. ¿Qué marcas, empresas o figuras en internet influyen en sus decisiones o le generan mayor confianza? |
| **Preguntas para Segmento 1: Dueños de negocios y emprendedores (Clientes)** | 12. ¿Cuáles son los objetivos principales que busca alcanzar al administrar la logística de su empresa? <br> 13. ¿Cuáles son sus mayores frustraciones o miedos al contratar un servicio de transporte de carga desconocido? <br> 14. ¿Qué canales o métodos utiliza actualmente para contactar transportistas cuando necesita mover mercadería de valor? <br> 15. ¿Ha tenido alguna experiencia negativa (robo, pérdida o daño de carga)? ¿Cómo impactó eso a su negocio? <br> 16. ¿Qué documentos legales o garantías le exige a un conductor antes de entregarle su carga? <br> 17. Si existiera una plataforma digital enfocada en negocios que valide rigurosamente a los conductores, ¿qué características indispensables tendría que tener para que decida adoptarla en su empresa? |
| **Preguntas para Segmento 2: Transportistas y dueños de vehículos de carga** | 12. ¿Cuáles son sus principales objetivos financieros y profesionales trabajando en el rubro del transporte? <br> 13. ¿Cuáles son las mayores frustraciones o riesgos que enfrenta al buscar empresas para realizar fletes? <br> 14. ¿Qué aplicaciones o canales utiliza actualmente para conseguir viajes de carga y qué problemas encuentra en ellos? <br> 15. ¿Alguna vez ha tenido problemas de seguridad, asaltos o clientes que no le pagaron el servicio acordado? <br> 16. ¿Qué opina sobre la alta informalidad en su sector y de qué forma cree que le afecta? <br> 17. ¿Estaría dispuesto a pasar por un proceso estricto de validación documental (antecedentes policiales, SOAT, revisión técnica) a cambio de acceder a una red segura de clientes empresariales? |
